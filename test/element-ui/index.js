		...
		var Gs = r({
			...
			mounted: function() {
				...
				!t && this.$refs.wrapper.children && (t = this.referenceElm = this.$refs
						.wrapper.children[0]), t && (fe(t, "el-popover__reference"), t
						...
						}), he(i, "focusin", this.handleFocus), he(t, "focusout", this
							.handleBlur), he(i, "focusout", this.handleBlur)), he(t,
			...
			uc = r({
				...
				methods: {
					...
					syncCheckedValue: function() {
						var e = this.value,
							t = this.checkedValue;
						I(e, t) || (this.activePath = [], this.checkedValue = e, this
							.syncMenuState())
					},
			...
			watch: {
				visible: function(e) {
					...
					e ? (this.closed = !1, this.$emit("open"), this.appendToBody && document
						...
						.activeElement) : (this.closed || this.$emit("close"), this
						.$nextTick(function() {
